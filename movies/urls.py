...
urlpatterns = [
    ...
    path('<int:movie_id>/', views.movie_detail, name='movie_detail'),  # Detalles de la película
    path('<int:movie_id>/add_review/', views.add_review, name='add_review'),  # Agregar reseña
